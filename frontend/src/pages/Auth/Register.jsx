...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-5/12 xl:w-[44%] flex-col justify-between bg-slate-950 relative overflow-hidden px-12 py-14">
        ...
        <div className="relative">
          ...
          <p className="text-slate-400 text-[15px] leading-relaxed mb-10 max-w-sm">
            Create your account in seconds and start collaborating with your team on tasks, projects, and goals.
          </p>
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-6 py-12 sm:px-12 overflow-y-auto">
        <div className="w-full max-w-[400px] animate-fade-in">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-500 mt-1.5 text-sm">Get started free — takes less than a minute</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 rounded-lg py-3 text-sm font-semibold text-white transition-all duration-150 hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 disabled:opacity-55 disabled:cursor-not-allowed active:scale-[0.99] mt-1"
            ...
            <p className="text-xs text-center text-slate-400 pt-1">
              ...
              <span className="text-slate-600 font-medium">Terms of Service</span> and{' '}
